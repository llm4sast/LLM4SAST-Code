...
class ProtectedConstructorStaticInitReordered {
    ...
    static { instance = new ProtectedConstructorStaticInitReordered(); }
    public static synchronized ProtectedConstructorStaticInitReordered getInstance() { return instance; }
