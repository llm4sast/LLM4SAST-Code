...
public class Ideas_2010_01_11 {
    ...
    static String get(String k) { return h.get(k); }
    static String get2(String k) {
        String result;
        try {
            result = h.get(k);
        } catch (Exception e) { result = "unknown2"; }
        return result;
    }
    static String get3(String k) {
        ...
        try {
            result = h.get(k);
        } catch (RuntimeException e) { result = "unknown3"; }
        return result;
    }
    static String get4(String k) {
        ...
        try {
            result = h.get(k);
        } catch (NullPointerException e) { result = "unknown4"; }
        return result;
    }
