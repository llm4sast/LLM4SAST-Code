...
public class ArrayToString {
    ...
    public void print0(String args[]) { System.out.println(args.toString()); }
    @DesireWarning("USELESS_STRING")
    public void print1() {
    ...
    public void print2() { System.out.println((new String[] { "one", "two" }).toString()); }
    @DesireWarning("DMI_INVOKING_TOSTRING_ON_ARRAY")
    public void print3() { System.out.println(gargs.toString()); }
}