...
public abstract class TestTypeQualifiersOnPrimitiveValues {
    ...
    @ExpectWarning("TQ")
    public void report1(@NeverBlue int x) { blueField = x; }
    @ExpectWarning("TQ")
    public void report2() { blueField = returnsNeverBlue(); }
    @ExpectWarning("TQ")
    public void report3() {
    ...
    @NoWarning("TQ")
    public void ok1(@AlwaysBlue int x) { blueField = x; }
    @NoWarning("TQ")
    public void ok2() { blueField = returnsAlwaysBlue(); }
    @NoWarning("TQ")
    public void ok3() {
