...
public class Ideas_2013_05_06 {
    ...
    public @interface PK { }
    public static @PK
    long asPK(long pk) { return pk; }
    @PK long x,y;
    public @PK long getX() { return x; }
    public @PK long getY() { return y; }
    ...
    public void test2( @PK long x, boolean c,  @PK long y, boolean b) { callme(b, x,b, y,b); }
}