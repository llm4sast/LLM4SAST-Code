...
public class Feature301 {
    ...
    public void caaField2() { field2 = new Number[10]; }
    @ExpectWarning("CAA_COVARIANT_ARRAY_FIELD")
    public void caaParent() { parents = new Child[10]; }
    @ExpectWarning("CAA_COVARIANT_ARRAY_RETURN")
    public Number[] caaReturn() { return new Integer[10]; }
    @ExpectWarning("CAA_COVARIANT_ARRAY_ELEMENT_STORE")
    public void caaStore() { field[0] = 1.0; }
    @NoWarning("CAA_COVARIANT_ARRAY_ELEMENT_STORE")
    public void caaStoreOk() { field2[0] = 1; }
    @NoWarning("CAA_COVARIANT_ARRAY_ELEMENT_STORE")
    public void caaStoreNoReport(Parent p) { parents[0] = p; }
}