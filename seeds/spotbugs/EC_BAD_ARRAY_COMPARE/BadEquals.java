...
class BadEquals {
    ...
    @ExpectWarning("EC")
    public boolean b(int[] a, Object[] b) { return a.equals(b); }
    @ExpectWarning("EC")
    public boolean b(int[] a, long[] b) { return a.equals(b); }
    @ExpectWarning("EC")
    public boolean b(int[] a, String b) { return a.equals(b); }
    @ExpectWarning("EC")
    public boolean b(int[] a, int[][] b) { return a.equals(b); }
    @ExpectWarning("EC")
    public boolean b(int[] a, double[] b) { return a.equals(b); }
}