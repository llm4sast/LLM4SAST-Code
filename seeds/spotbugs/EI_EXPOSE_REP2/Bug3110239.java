...
public class Bug3110239 implements Serializable {
    ...
    public List<Bug3110239> getSubSectors() { return subSectors; }
    public void setSubSectors(List<Bug3110239> subSectors) { this.subSectors = subSectors; }
    public Set<String> getCompanies() { return companies; }
    public void setCompanies(Set<String> companies) { this.companies = companies; }
}