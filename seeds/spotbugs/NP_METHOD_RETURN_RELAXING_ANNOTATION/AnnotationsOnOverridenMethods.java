...
public class AnnotationsOnOverridenMethods {
	@Nonnull Object foo(@CheckForNull Object o) { return o; }
	Object bar(Object o) { return o; }
	static class Child extends AnnotationsOnOverridenMethods {
		...
		@CheckForNull Object foo(@Nonnull Object o) { return o; }
		@Override
        @CheckForNull Object bar(@Nonnull Object o) { return o; }
	}
}