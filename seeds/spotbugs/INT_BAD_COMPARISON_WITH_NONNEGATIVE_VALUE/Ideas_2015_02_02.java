...
public class Ideas_2015_02_02 {
    ...
    public boolean isASCII(char c) { return c >= 0 && c < 128; }
    @NoWarning("INT_BAD_COMPARISON_WITH_NONNEGATIVE_VALUE")
    ...
    @NoWarning("INT_BAD_COMPARISON_WITH_NONNEGATIVE_VALUE")
    public boolean isOneByte(char c) { return c >= 0 && c <= 255; }
    @NoWarning("INT_BAD_COMPARISON_WITH_NONNEGATIVE_VALUE")
    public boolean isASCIIBroken(char c) { return c >= 0 && c < 80; }
    @ExpectWarning("INT_BAD_COMPARISON_WITH_NONNEGATIVE_VALUE")
    public boolean isNonNegative(char c, char b) { return c >= 0 && b >= 0; }
    @ExpectWarning("INT_BAD_COMPARISON_WITH_NONNEGATIVE_VALUE")
