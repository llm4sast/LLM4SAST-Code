...
public class Ideas_2010_04_29 {
    ...
    static class Test3 {
        ...
        void m() throws SQLException {
            ...
            try {
                ...
                for (;;) { throwSomething(); }
            } catch (MyException e) { conn.rollback(); }
        }
        private void throwSomething() throws MyException { throw new MyException(); }
        class MyException extends Exception { }
        private Connection createConnection() throws SQLException { return DriverManager.getConnection("", "", ""); }
    }
    @NoWarning("NP_ALWAYS_NULL,NP_NULL_ON_SOME_PATH")
    public void test4() {
        String dummy = null;
        for (int i = 0; i < 10; i++) {
            ...
            if (i % 2 != 0) { System.out.println(dummy.toLowerCase()); }
            dummy = null;
        }
    }
    public void test4a() {
        ...
        for (int i = 0; i < 10; i++) {
            if (i % 2 != 0) { dummy = "Foo"; }
            System.out.println("Hello");
            if (dummy != null && i % 2 != 0) { System.out.println(dummy.toLowerCase()); }
            dummy = null;
        }
    }
        ...
        while (true) {
            ...
            if (isOpenVariableMortageRateProduct) {
                if (tblVarRplAllElementAddedIndicator == false)
                    tblVarRpl = "";
                tblVarRpl = tblVarRpl.substring(1); 
                return;
            }
        }
    }
    ...
    public void test8(boolean fail) throws Exception {
        ...
        } catch (IOException e) { Assertions.assertEquals("Hello", v.toString()); }
    }
