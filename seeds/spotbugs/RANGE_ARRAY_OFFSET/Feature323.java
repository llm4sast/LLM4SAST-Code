...
public class Feature323 {
    ...
    public int getValue() { return array[4]; }
    @NoWarning("RANGE_ARRAY_INDEX")
    public int getValue3() { return array[3]; }
    @ExpectWarning("RANGE_ARRAY_INDEX")
    ...
    @NoWarning("RANGE")
    public String strEmpty() { return new String(new char[0], 0, 0); }
    @ExpectWarning("RANGE_STRING_INDEX")
    public String trimSubstring() { return TEST_STRING.trim().substring(TEST_STRING.length()); }
    ...
    @ExpectWarning("RANGE_STRING_INDEX")
    public String substringIncorrect() { return TEST_STRING.substring(TEST_STRING.length()+1); }
    @ExpectWarning("RANGE_STRING_INDEX")
    public String substringIncorrect2() { return TEST_STRING.substring(1, TEST_STRING.length()+1); }
    @ExpectWarning("RANGE_STRING_INDEX")
    public String substringIncorrect3() { return TEST_STRING.substring(2, 1); }
    @NoWarning("RANGE_STRING_INDEX")
    public char charAtCorrect() { return TEST_STRING.charAt(TEST_STRING.length()-1); }
    @ExpectWarning("RANGE_STRING_INDEX")
    public char charAtIncorrect() { return TEST_STRING.charAt(TEST_STRING.length()); }
}