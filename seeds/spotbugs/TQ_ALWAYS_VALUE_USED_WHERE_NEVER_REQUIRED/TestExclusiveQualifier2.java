...
public class TestExclusiveQualifier2 {
    ...
    @NoWarning("TQ")
    void setRed(@AlwaysRed Object redField) { this.redField = redField; }
    @ExpectWarning("TQ")
    public void report1(@AlwaysBlue Object v) { redField = v; }
    @ExpectWarning("TQ")
    ...
    @NoWarning("TQ")
    public void doNotReport(Object b) { redField = b; }
}