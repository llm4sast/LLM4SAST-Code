...
public class AssertionsWithSideEffects {
    ...
    private static class ImmutableList<Element> {
        Object[] elements;
        public ImmutableList() { elements = new Object[0]; }
        ...
        public ImmutableList<Element> add(Element e) { return new ImmutableList<Element>(elements, e); }
        public boolean isEmpty() { return elements.length == 0; }
    }
    private static ImmutableList<String> il = new ImmutableList<>();
    public static void add() { assert !il.add("a").isEmpty(); }
}