...
public class Bug1325<P extends java.io.Serializable & Comparable<P>> implements java.io.Serializable, Comparable<Bug1325<P>> {
    ...
    @Override
    public int hashCode() { return (31 + (endPoint == null ? 0 : endPoint.hashCode())) * 31 + (startPoint == null ? 0 : startPoint.hashCode()); }
    @Override
    ...
    public static class Alt<P extends Comparable<P> & java.io.Serializable> implements java.io.Serializable,
        ...
        public int hashCode() { return (31 + (endPoint == null ? 0 : endPoint.hashCode())) * 31 + (startPoint == null ? 0 : startPoint.hashCode()); }
        @Override
        public boolean equals(Object obj) { return obj instanceof Alt && startPoint.equals(((Alt) obj).startPoint) && endPoint.equals(((Alt) obj).endPoint); }
    }
}