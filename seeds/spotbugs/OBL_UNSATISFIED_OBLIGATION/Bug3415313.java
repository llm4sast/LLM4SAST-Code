...
public class Bug3415313 {
    ...
    public void fp1(Connection sesscon) throws SQLException {
        ...
        try {
            ...
            rs = ps.executeQuery();
            while (rs.next()) { }
            } finally { WorkflowUtils.closeResultSet(rs); }
        } finally { WorkflowUtils.closeStatement(ps); }
    }
    @NoWarning("OBL_UNSATISFIED_OBLIGATION")
    ...
    public void tp2(Connection sesscon) throws SQLException {
        ...
        try {
            ...
            try {
                rs = ps.executeQuery();
                while (rs.next()) { }
            } finally { WorkflowUtils.bar(); }
        } finally { WorkflowUtils.baz(); }
    }
