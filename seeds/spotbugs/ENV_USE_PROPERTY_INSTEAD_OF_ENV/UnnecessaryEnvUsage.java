...
public class UnnecessaryEnvUsage {
    ...
    public void replaceableEnvUsageFromMap() { System.getenv().get("JAVA_HOME"); }
    ...
    public void replaceableEnvUsageWithField() { System.getenv(ARCH); }
    public void replaceableEnvUsageWithVarFromMap() {
        String envName = "OS";
        System.getenv().get(envName);
    }
    private static final String USER = "USER";
    public void replaceableEnvUsageWithFieldFromMap() { System.getenv().get(USER); }
    ...
    public void necessaryEnvUsage() { System.getenv("CUSTOM_ENV_FIELD"); }
    public void necessaryEnvUsageFromMap() { System.getenv().get("CUSTOM_ENV_FIELD"); }
    ...
    public void necessaryEnvUsageWithField() { System.getenv(CUSTOM_ENV_FIELD); }
    public void necessaryEnvUsageWithFieldFromMap() { System.getenv().get(CUSTOM_ENV_FIELD); }
    public void necessaryEnvUsageWithFieldFromMapWithVar() {
        Map<String,String> envVars = System.getenv();
        envVars.get(CUSTOM_ENV_FIELD);
    }
    public void compliantPropertyUsage() { System.getProperty("user.name"); }
}