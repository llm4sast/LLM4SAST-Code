...
public class UseOfNonHashableClassInHashDataStructure {
    ...
    static int foo(HashMap<UseOfNonHashableClassInHashDataStructure, String> map) { return map.size(); }
    @Override
    public boolean equals(Object o) { return hashCode() == o.hashCode(); }
    public static String add(UseOfNonHashableClassInHashDataStructure b, String s) { return m.put(b, s); }
    public static String get(UseOfNonHashableClassInHashDataStructure b) { return m.get(b); }
}