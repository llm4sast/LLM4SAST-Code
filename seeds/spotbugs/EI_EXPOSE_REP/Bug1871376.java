...
class Bug1871376 implements Serializable {
    ...
    public Date getCreationDate() { return m_created; }
    public String getFirstCharOfKey(@NonNull String key) {
        ...
        } else { value = m_map.get(key); }
        return value.substring(0, 1);
    }
    public synchronized static boolean didBuildAMap() { return s_builtAMap; }
    public static void main(String[] args) {
        Bug1871376 buggy = new Bug1871376();
        String key = null;
        buggy.getFirstCharOfKey(key);
        synchronized (buggy) { System.out.println("Built a map: " + s_builtAMap); }
    }
    private class NonSerializableMap extends AbstractMap<String, String> {
        ...
        @Override
        public Set<java.util.Map.Entry<String, String>> entrySet() { return m_map.entrySet(); }
    }
}