...
public abstract class Ideas_2009_05_20 {
        ...
        while (list.size() > 0) {
            ...
            while (iterator.hasNext()) {
                ...
                if (specification.equals(other)) {
                    ...
                    if (null != sections) { sections.addAll(Arrays.asList(otherSections)); }
                    iterator.remove();
                }
            }
    ...
    private static Ideas_2009_05_20 mergeInSections(Ideas_2009_05_20 specification, ArrayList<String> sections) { return specification; }
    private String[] getSections() { return new String[] { "a" }; }
}