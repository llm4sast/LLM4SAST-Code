class NonShortCircuit {
    boolean b;
    boolean arrayDanger(int[] a, int i, int x) { return i < a.length & a[i] == x; }
    boolean bothBitsFalsePositive(int i) { return and((i & 0x1) != 0, (i & 0x2) != 0); }
    boolean bothBitsFalsePositive2(int i) { return combine((i & 0x1) != 0, (i & 0x2) != 0, (i & 0x4) != 0) != 0; }
    ...
    boolean nonEmpty(Object o[]) { return o != null & o.length > 0; }
    public static final int BIT0 = 1; 
    protected int m_iType;
    public NonShortCircuit(boolean available) { m_iType |= available ? BIT0 : 0; }
