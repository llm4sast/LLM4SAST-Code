class A {
  ...
  private static final Log
      foo; // Noncompliant {{Rename the "foo" logger to comply with the format "LOG(?:GER)?".}}
  //                         ^^^
  ...
  private static Log
      foo4; // Noncompliant {{Make the "foo4" logger private static final and rename it to comply

  // with the format "LOG(?:GER)?".}}
