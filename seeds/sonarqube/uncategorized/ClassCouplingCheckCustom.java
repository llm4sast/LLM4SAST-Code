...
class Baz { // Noncompliant {{Split this class into smaller and more specialized ones to reduce its
  // dependencies on other classes from 23 to the maximum authorized 22 or less.}}
  T1 a1;
  T2 a2;
  T3 a3;
  T4 a4;
