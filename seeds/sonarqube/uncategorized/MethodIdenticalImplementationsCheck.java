abstract class A {
  private static final String CODE = "bounteous";
  private String code;
  ...
  public String getName() {
    return code;
  } // Noncompliant {{Update this method so that its implementation is not identical to "getCode" on
  ...
  String getOtherName() {
    return CODE;
  } // Compliant - not getters (not public)
  ...
  void
      greek2() { // Noncompliant {{Update this method so that its implementation is not identical to
    // "greek1" on line 15.}}
    //     ^^^^^^
    Object x = null;
    try {
...
abstract class E {
  ...
  // Compliant - foo2() looks similar but types of LocalB and LocalA are different. Only their
