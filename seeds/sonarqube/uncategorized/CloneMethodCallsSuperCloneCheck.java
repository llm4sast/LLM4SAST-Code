class A {
  @Override
  protected A clone()
      throws CloneNotSupportedException { // Noncompliant {{Use super.clone() to create and seed the
    // cloned instance to be returned.}}
    //            ^^^^^
    return new A();
  }
...
class E {
  @Override
  protected Object clone(Object a)
      throws CloneNotSupportedException { // Compliant - does not override Object.clone()
    return a;
  }
}
