...
public class Raspberry extends Fruit
    implements Serializable { // No access to parent's readResolve() method
}
...
public class Fruit5 {
  private Object readResolve()
      throws ObjectStreamException // compliant, Fruit5 is not a subtype of Serializable
      {}
}
...
public class Fruit6 implements Serializable {
  ...
  private Object readResolve(int a)
      throws ObjectStreamException // compliant, not read resolve method
      {}
