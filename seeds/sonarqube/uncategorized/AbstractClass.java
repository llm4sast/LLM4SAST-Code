final class PrivateConstructorFinalClass { // Compliant, declared final
...
class PrivateConstructorNotFinalClass { // Noncompliant {{Make this class "final" or add a public
  // constructor.}}
...
class PrivateAndPublicConstructorClass { // Compliant, one public constructor
...
class ProtectedConstructorClass { // Compliant, all constructors are not private
...
class NoConstructorClass { // Compliant, implicit constructor has package visibility
}

abstract class AbstractClass { // Compliant, constructor is used in
