...
public class MyStream
    extends InputStream { // Noncompliant {{Provide an override of "read(byte[],int,int)" for this
  // class.}}
  //           ^^^^^^^^
...
public class MyStream6
    extends InputStream { // Noncompliant {{Provide an empty override of "read(byte[],int,int)" for
  // this class as well.}}
  @Override
  public int read(int b) throws IOException {}
}
