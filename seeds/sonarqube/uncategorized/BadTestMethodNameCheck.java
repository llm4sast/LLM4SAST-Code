...
class ATest {
  @Test
  void foo() {} // Noncompliant {{Rename this method name to match the regular expression:
  ...
  void foo_2() {} // Noncompliant {{Rename this method name to match the regular expression:
  ...
  Collection<DynamicTest> foo_5() { // Noncompliant
    return Arrays.asList(
        dynamicTest("1", () -> assertTrue(true)), dynamicTest("2", () -> assertTrue(false)));
  }
