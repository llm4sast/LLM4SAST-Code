class A {
  ...
  void m3() throws Exception {
    ...
    while (i++ < 10) {
      foo();
      throw new Exception(
          "BOUM!"); // Noncompliant {{Remove this "throw" statement or make it conditional.}}
    }
  }
  ...
  boolean foo(int last, char[] b, char[] src) {
    ...
    while (i <= last) {
      ...
      break; // compliant, there is another way to get back to the 'while' loop from the inner 'for'
      // loop
    }
