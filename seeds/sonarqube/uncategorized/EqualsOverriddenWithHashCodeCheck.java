...
class B {
  public boolean equals(
      Object
          o) { // Noncompliant {{This class overrides "equals()" and should therefore also override
    // "hashCode()".}}
    //               ^^^^^^
  }
}
...
class C {
  public int
      hashCode() { // Noncompliant {{This class overrides "hashCode()" and should therefore also
    // override "equals()".}}
    //           ^^^^^^^^
  }
}
