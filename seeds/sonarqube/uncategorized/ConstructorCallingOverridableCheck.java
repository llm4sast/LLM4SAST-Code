...
class B extends A {
  ...
  B(B otherB) {
    nonFinalPublicMethod(); // Noncompliant {{Remove this call from a constructor to the overridable
    // "nonFinalPublicMethod" method.}}
...
public class Child extends Parent {
  ...
  public Child(String foo) {
    super(); // leads to call doSomething() in Parent constructor which triggers a
    // NullPointerException as foo has not yet been initialized
    this.foo = foo;
  }
