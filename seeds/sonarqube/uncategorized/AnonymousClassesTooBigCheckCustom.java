class A {
  private void f() {
    ...
    new Comparable<
        T>() { // Noncompliant {{Reduce this anonymous class number of lines from 7 to at most 6, or
      // make it a named class.}}
      private void f() { // 2
        System.out.println(); // 3
        System.out.println(); // 4
    ...
    new Comparable<
        T>() { // Noncompliant {{Reduce this anonymous class number of lines from 17 to at most 6,
      // or make it a named class.}}
