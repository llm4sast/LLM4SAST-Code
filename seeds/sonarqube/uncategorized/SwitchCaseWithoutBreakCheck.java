class A {
  ...
  private void f(byte b, char c) {
    ...
    switch (myVariable) {
      case 0:
      case 1: // Noncompliant {{End this switch case with an unconditional break, return or throw
        // statement.}}
        //    ^^^^^^^
      ...
      case 2: // Compliant
        break;
      case (8
          | 2): // Noncompliant {{End this switch case with an unconditional break, return or throw
        // statement.}}
        //    ^^^^^^^^^^^^^
        System.out.println("Test");
      case 3: // Compliant
    ...
    switch (b) {
      case (byte) 0: // Compliant
        break;
      case (byte)
          1: // Noncompliant {{End this switch case with an unconditional break, return or throw
        // statement.}}
        //    ^^^^^^^^^^^^^^
        System.out.println("Test");
      case 2: // Compliant
        break;
      case 3: // Noncompliant {{End this switch case with an unconditional break, return or throw
        // statement.}}
        //    ^^^^^^^
    ...
    switch (c) {
      case 'c': // Compliant
        break;
      case 'a': // Noncompliant {{End this switch case with an unconditional break, return or throw
        // statement.}}
        //    ^^^^^^^^^
        System.out.println("Test");
      case 'd': // Compliant
        break;
      case 'e': // Noncompliant {{End this switch case with an unconditional break, return or throw
        // statement.}}
        //    ^^^^^^^^^
        System.out.println("Test 2");
      case 'x':
...
class NestedSwitches {
  ...
  public int test1(String s, E e, int i) {
    switch (s) {
      case "FOO":
        return 0;
      case "BAR": // Compliant - all cases in the following switch have unconditional termination
        // statements
        switch (e) {
          case A:
            switch (i) {
