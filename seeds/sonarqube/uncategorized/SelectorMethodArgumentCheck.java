class A {
  public void tempt(
      String name,
      boolean
          ofAge) { // Noncompliant {{Provide multiple methods instead of using "ofAge" to determine
  ...
  public void doOtherStuff(
      boolean
          willingly) { // Noncompliant {{Provide multiple methods instead of using "willingly" to
...
abstract class B {
  ...
  public abstract int bar(int a, boolean b); // Compliant
  ...
  public int hop(
      int a,
      boolean
          b) { // Noncompliant {{Provide multiple methods instead of using "b" to determine which
    // action to take.}}
    class InnerClass {
      int foo() {
        if (b) {
