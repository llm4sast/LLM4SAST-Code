...
public class ThrowsSeveralCheckedException extends Base {
  ...
  public void foo9()
      throws IOException,
          MyException { // Noncompliant {{Refactor this method to throw at most one checked
    // exception instead of: java.io.IOException,
    // ThrowsSeveralCheckedException$MyException}}
    //            ^^^^
  }
  ...
  public void foo10()
      throws IOException,
          IOException,
          SQLException { // Noncompliant {{Refactor this method to throw at most one checked
    // exception instead of: java.io.IOException, java.io.IOException,
  ...
  public void foo12()
      throws IOException,
          UnknownException { // Compliant - in order to avoid false positives, we do not raise issue
  ...
  public void overriddenMethod()
      throws IOException, SQLException { // Compliant - overridden methods
  }
}
...
class BaseClass<T> {
  public T meth() throws IOException, SQLException {
    return null;
  } // Noncompliant
}
...
class Synth extends BaseChildClass<Integer> {
  @Override
  public Integer meth() throws IOException {
    return 1;
  }
}
...
class J {
  ...
  public J method2(int a, String b) throws IOException, SQLException {
    return null;
  } // Noncompliant

  public String method3(int a, String b) throws IOException, SQLException {
    return null;
  } // Noncompliant
}
...
class K extends J {
  ...
  public K method2(int a, String b) throws IOException, SQLException {
    return null;
  }

  public String method3(int a) throws IOException, SQLException {
    return null;
  } // Noncompliant
}
...
class S<T> {
  public T method(T a) throws IOException, SQLException {
    return null;
  } // Noncompliant
}

class U extends S<String> {
  public String method(String a) throws IOException, SQLException {
    return null;
  } // false positive
}
