class B {
  private void f() {
    ...
    try {
      ...
      throw new Exception(); // Noncompliant {{Remove this throw statement from this finally
      // block.}}
      //    ^^^^^
    }
  }
  ...
  void fp() {
    ...
    for (; ; ) {
      try {
        ...
        while (true) {
          continue
              outer; // FN - requires CFG to detect this, but let's not overcomplicate this rule
          break; // Compliant
        }
      }
    }
