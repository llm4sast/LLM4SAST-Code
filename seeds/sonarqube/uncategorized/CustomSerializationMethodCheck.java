...
class C implements Serializable { // static methods
  private static void writeObject(ObjectOutputStream out)
      throws IOException {} // Noncompliant {{The "static" modifier should not be applied to
...
class E implements Serializable { // invalid return type
  Unknown writeReplace()
      throws ObjectStreamException {} // Noncompliant {{"writeReplace" should return
