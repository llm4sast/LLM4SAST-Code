class A {
  public Object
      clone() { // Noncompliant {{Remove this "clone" implementation; use a copy constructor or copy
    // factory instead.}}
    //              ^^^^^
    return super.clone();
  }
...
class B {
  ...
  protected Object clone()
      throws CloneNotSupportedException { // Compliant, common practice of overriding to throw an
    // exception
