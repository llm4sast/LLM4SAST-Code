class Foo { // Noncompliant {{Split this class into smaller and more specialized ones to reduce its
  // dependencies on other classes from 21 to the maximum authorized 20 or less.}}
  //    ^^^
...
class Plop { // Noncompliant {{Split this class into smaller and more specialized ones to reduce its
  // dependencies on other classes from 21 to the maximum authorized 20 or less.}}
  List<T1> a1;
  List<T2> a2;
  List<T3> a3;
...
public class FullyQualifiedName1
    extends sonar.source.support.a.b.c.d.e.f.g.h.i.j.k.l.m.n.o.p.q.r.s.t.T4 {
