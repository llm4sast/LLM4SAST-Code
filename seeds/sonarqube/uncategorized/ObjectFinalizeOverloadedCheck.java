class A {
  ...
  public void finalize(
      int a) { // Noncompliant {{Rename this method to avoid any possible confusion with
    // Object.finalize().}}
    //            ^^^^^^^^
  }

  private void finalize(
      int a, int b) { // Noncompliant {{Rename this method to avoid any possible confusion with
    // Object.finalize().}}
  }
