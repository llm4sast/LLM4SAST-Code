...
class A {
  ...
  void map() {
    ...
    map.put(
        "a",
        "Banana"); // Noncompliant {{Verify this is the key that was intended; it was already set
    // before.}}
    //        ^^^
  }
  ...
  void arrays() {
    ...
    ints[i] = 1;
    //       ^>
    ints[i] = 2; // Noncompliant {{Verify this is the index that was intended; it was already set
    // before.}}
    //     ^
  }
