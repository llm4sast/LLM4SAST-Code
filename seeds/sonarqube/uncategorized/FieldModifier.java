...
class D {
  @com.google.common.annotations.VisibleForTesting int member; // Compliant
  @org.assertj.core.util.VisibleForTesting final int var2; // Compliant
  @VisibleForTesting static int var3; // Compliant
...
enum E {
  ;
  @com.google.common.annotations.VisibleForTesting int varEnum; // Compliant
  @com.google.common.annotations.VisibleForTesting final int varEnum2; // Compliant
  @com.google.common.annotations.VisibleForTesting static int varEnum3; // Compliant
}
