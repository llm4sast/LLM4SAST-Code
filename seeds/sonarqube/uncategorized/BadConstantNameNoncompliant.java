class BadConstantName {
  ...
  public static final int bad_constant =
      0; // Noncompliant {{Rename this constant name to match the regular expression
  // '^[A-Z][A-Z0-9]*(_[A-Z0-9]+)*$'.}}
  //                        ^^^^^^^^^^^^
  ...
  interface Interface {
    int GOOD_CONSTANT = 1, bad_constant = 2; // Noncompliant
