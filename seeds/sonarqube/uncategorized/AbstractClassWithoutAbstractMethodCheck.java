...
public abstract
class AbstractColor { // Noncompliant {{Convert this "AbstractColor" class to a concrete class with
...
public abstract class Parametrized<
    T> { // Noncompliant {{Convert this "Parametrized" class to an interface}}
  abstract void foo();
}
