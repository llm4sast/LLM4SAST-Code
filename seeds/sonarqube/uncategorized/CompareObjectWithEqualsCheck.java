...
class NoIssueWhenNoEqualsOverride {
  ...
  private void foo(
      ClassWithEquals a1, ClassWithEquals a2, ClassWithoutEquals b1, ClassWithoutEquals b2) {
    if (a1 == b1) {} // Compliant
    if (b1 != a1) {} // Compliant
  ...
  private void foo(
      ClassWithEquals2 a1, ClassWithEquals2 a2, ClassWithoutEquals2 b1, ClassWithoutEquals2 b2) {
