...
class A {
  void foo() {
    ...
    } // Noncompliant {{Synchronize on a non-value-based object; synchronizing on a "HijrahDate"
    // could lead to contention. (sonar.java.source not set. Assuming 8 or greater.)}}
    ...
    } // Noncompliant {{Synchronize on a non-value-based object; synchronizing on a "Optional" could
    // lead to contention. (sonar.java.source not set. Assuming 8 or greater.)}}
