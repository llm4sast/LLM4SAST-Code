...
public enum
    FooEnum { // Noncompliant {{Document this public enum by adding an explicit description.}}
}

public interface Ainterface { // Noncompliant {{Document this public interface by adding an explicit
  // description.}}
}

public @interface
FooAnnotation { // Noncompliant {{Document this public annotation by adding an explicit
  // description.}}
}

public
class AClass { // Noncompliant {{Document this public class by adding an explicit description.}}

  public int a; // Noncompliant {{Document this public field by adding an explicit description.}}

  public
  A() { // Noncompliant {{Document this public constructor by adding an explicit description.}}
    System.out.println();
  }
}
...
public class Foo { // Compliant
  ...
  public int foo2(
      int a,
      int b,
      int c) { // Noncompliant {{Document this public method by adding an explicit description.}}
    return 0;
  }
  ...
  public <T> void foo4() { // Noncompliant {{Document this public method by adding an explicit
    // description.}}
  }
...
/** */
public interface bar { // Noncompliant {{Document this public interface by adding an explicit
  // description.}}
  /**
   * Valid descriptions.
   *
   * @param <A> the annotation type
   * @param annotationType the <tt>Class</tt> object corresponding to the annotation type
  ...
  static
  class A {} // Noncompliant {{Document this public class by adding an explicit description.}}
...
@interface nested {
  /** */
  static final
  class DEFAULT {} // Noncompliant {{Document this public class by adding an explicit description.}}
