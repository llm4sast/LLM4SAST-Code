...
class Locks {
  ...
  public void lockBothBranchesOk(boolean b) {
    if (b) { mLock.lock(); } else { mLock.lock(); }
    f = 42;
    mLock.unlock();
  }
  ...
  public void tryLockWrongBranchBad() {
    if (mReentrantLock.tryLock()) { } else { f = 42; }
  }
  ...
  public void negatedReentrantLockTryLockBad() { if (!mReentrantLock.tryLock()) { f = 42; } }
  ...
  private void acquireLock() { mLock.lock(); }
  ...
  private void releaseLock() { mLock.unlock(); }
  void nested1Ok() {
    synchronized (this) {
      synchronized (this) { }
      f = 32;
  ...
  void nested2Ok() {
    synchronized (this) { synchronized (this) { f = 32; } }
  }
  void nested3Ok() {
    synchronized (this) {
      f = 32;
  ...
  void useLock() { synchronized (this) { } }
  ...
  boolean mField;
  boolean readUnderLockOk() { synchronized (this) { return mField; } }
  void writeUnderLockOk() { synchronized (this) { mField = true; } }
  ...
  public boolean readInTryCatchWithLockOk() {
    mLock.lock();
    try { return mField; } finally { mLock.unlock(); }
  }
  public void writeInsideTryCatchWithLockOk() {
    mLock.lock();
    try { mField = true; } finally { mLock.unlock(); }
  }
  Object mField2;
  private synchronized void lockedWriteInCallee() { this.mField2 = null; }
  public static void ownedLockedReadOk() {
    Locks owned = new Locks();
    owned.lockedWriteInCallee();
  }
  public Object unownedReadOk() { return this.mField2; }
  Object mField3;
  private synchronized void lockedWriteInCallee2() { this.mField3 = null; }
  public void unownedLockedWriteOk() { lockedWriteInCallee2(); }
  public Object unownedReadBad() { return this.mField3; }
}