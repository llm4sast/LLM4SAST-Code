...
class NullPointerExceptions {
  ...
  public static void expectNotNullObjectParameter(A a) { a.method(); }
  public static void expectNotNullArrayParameter(A[] array) { array.clone(); }
  ...
  public int nullPointerExceptionWithExceptionHandling(boolean ok) {
    A a = null;
    try { throw new Exception(); } catch (Exception e) { return a.x; }
  }
  class B {
    A a;
    public B() {}
  ...
  class C { B b; }
  public int FN_nullPointerExceptionWithNullByDefaultBad(C c) { return (new B()).a.x; }
  public int nullPointerExceptionWithExplicitNullInitBad(C c) { return (new B(null)).a.x; }
  public int FN_nullPointerExceptionWithAChainOfFields(C c) {
    c.b = new B();
    return c.b.a.x;
  }
  public static void nullPointerExceptionWithNullObjectParameter() { expectNotNullObjectParameter(null); }
  public static void nullPointerExceptionWithNullArrayParameter() { expectNotNullArrayParameter(null); }
  public static void nullPointerExceptionFromFaillingResourceConstructor() throws IOException {
    FileInputStream fis = null;
    try {
      fis = new FileInputStream(new File("whatever.txt"));
    } catch (IOException e) { } finally { fis.close(); }
  }
  public static void nullPointerExceptionFromFailingFileOutputStreamConstructor()
    ...
    } catch (IOException e) { } finally { fos.close(); }
  }
  int x;
  ...
  public void genericMethodSomewhereCheckingForNull(String s) { if (s == null) {} }
  ...
  String hashmapNPE(HashMap h, Object o) { return (h.get(o).toString()); }
  String NPEhashmapProtectedByContainsKey(HashMap h, Object o) {
    if (h.containsKey(o)) { return (h.get(o).toString()); }
    return "aa";
  }
  int NPEvalueOfFromHashmapBad(HashMap<Integer, Integer> h, int position) { return h.get(position); }
  Integer NPEvalueOfFromHashmapGood(HashMap<Integer, Integer> h, int position) { return h.get(position); }
  ...
  public int cursorQueryShouldNotReturnNull(SQLiteDatabase sqLiteDatabase) {
    ...
    try { return cursor.getCount(); } finally { cursor.close(); }
  }
  ...
  void FN_nullableFieldNPE() { mFld.toString(); }
  void guardedNullableFieldDeref() { if (mFld != null) mFld.toString(); }
  void allocNullableFieldDeref() {
    mFld = new Object();
    mFld.toString();
  }
  void nullableParamNPE(@Nullable Object param) { param.toString(); }
  void guardedNullableParamDeref(@Nullable Object param) { if (param != null) param.toString(); }
  ...
  Object getObj() {
    if (test1()) { return new Object(); } else { return null; }
  }
  Boolean getBool() {
    if (test2()) { return new Boolean(true); } else { return null; }
  }
  void derefGetterAfterCheckShouldNotCauseNPE() { if (getObj() != null) { getObj().toString(); } }
  void derefBoxedGetterAfterCheckShouldNotCauseNPE() { boolean b = getBool() != null && getBool(); }
  static void derefNonThisGetterAfterCheckShouldNotCauseNPE() {
    NullPointerExceptions c = new NullPointerExceptions();
    if (c.getObj() != null) { c.getObj().toString(); }
  }
  void badCheckShouldCauseNPE_latent() { if (getBool() != null) { getObj().toString(); } }
  ...
  void nullableNonNullStringAfterTextUtilsIsEmptyCheckShouldNotCauseNPE(@Nullable String str) { if (!TextUtils.isEmpty(str)) { str.length(); } }
  ...
  public void nullableFieldReassign1() {
    if (mNullableField == null) { mNullableField = mOkObj; }
    mNullableField.toString();
  }
  public void nullableFieldReassign2(Object okObj) {
    if (mNullableField == null) { mNullableField = okObj; }
    mNullableField.toString();
  }
  ...
  public Object nullableGetter() { return mNullableField; }
  ...
  void assumeUndefNullableIdempotentOk() { if (undefNullableRet() != null) { undefNullableRet().toString(); } }
  public Object undefNullableWrapper() { return undefNullableRet(); }
  public void derefUndefNullableRetWrapper() { undefNullableWrapper().toString(); }
  ...
  public void testNullablePrecision() {
    Object ret = undefNullableRet();
    if (returnsThreeOnlyIfRetNotNull(ret) == 3) { ret.toString(); }
  }
  ...
  Object retUndefined() { return "".toString(); }
  Object derefUndefinedCallee() {
    retUndefined().toString();
    return null;
  }
  void derefNull() { derefUndefinedCallee().toString(); }
  ...
  Object callUnknownFunc() { return unknownFunc(); }
  ...
  @Nullable
  Object wrapUnknownFuncWithNullable() { return unknownFunc(); }
  void deferenceNullableMethodCallingSkippedMethodBad() { wrapUnknownFuncWithNullable().toString(); }
  ...
  void dereferenceAfterUnlock2(Lock l) {
    synchronized (l) { String b = null; }
    String s = l.toString();
    s = null;
    s.toString(); 
  }
  void optionalNPE(Optional<Object> o) { o.orNull().toString(); }
  void FP_stringConstantEqualsTrueNotNPE() {
    final String c1 = "Test string!";
    final String c2 = "Test string!";
    String s = null;
    if (c1.equals(c1)) { s = "safe"; }
    s.toString(); 
    s = null;
    if (c1.equals(c2)) { s = "safe"; }
    s.toString(); 
  }
  ...
  String getString2() { return "string 2"; }
  void stringVarEqualsFalseNPE() {
    final String c1 = "Test string 1";
    String c2 = "Test " + getString2();
    String s = null;
    if (!c1.equals(c2)) { s.toString(); }
  }
  String assertParameterNotNullableOk(@Nullable Object object) { return Assertions.assertNotNull(object).toString(); }
  interface I { @Nullable Object mObject = null; }
  class E implements I { void FN_dereferenceNullableInterfaceFieldBad() { mObject.toString(); } }
  ...
  void call_incr_deref2_bad() {
    ...
    incr_deref2(a, a);
    incr_deref2(a1, a2);
    if (a1.x == 1 && a2.x == 1 && a.x == 2) { a1 = null; }
    a1.x = 0;
  }
  ...
  void incr_deref3(A a1, A a2, A a3) { a1.x++; }
  ...
  interface AFunction { void run(A a); }
