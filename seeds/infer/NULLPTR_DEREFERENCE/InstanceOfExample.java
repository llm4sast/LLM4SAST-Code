...
class InstanceOfExample {
  ...
  public void testInstanceOfObjFacultyOk() {
    ...
    Person p2 = null;
    if (p instanceof Faculty) { p2 = new Student(); }
    p2.toString();
  }
  public Person updatePerson(Person p) {
    Person new_p = null;
    if (p instanceof Student) { new_p = p; }
    return new_p;
  }
  ...
  public void testInstanceOfNullInterOk() {
    Person p = new Professor();
    p = updatePerson(p);
    if (p instanceof Professor) { p.toString(); }
  }
  ...
  public void checkInstanceArrayLatent(Object array, boolean b) {
    Object o = null;
    if (array instanceof int[]) { o = new Object(); }
    if (b && array instanceof boolean[]) { o.toString(); }
  }
  ...
  public List<Integer> createsEmptyList() { return new ArrayList<Integer>(); }
  ...
  public String getClassByName(Object o) { return o.getClass().getName(); }
  public void requiresFurtherInvestigationOk(List<Person> people) { people.stream().filter(p -> getClassByName(p).equals("Student") && p instanceof Student); }
}