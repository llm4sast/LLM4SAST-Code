...
class Lists {
  void emptyRemembersOk(List l) {
    ...
    Object o = null;
    if (empty != l.isEmpty()) { o.toString(); }
  }
  void removeInvalidatesNonEmptinessNPEBad(List l) {
    l.removeAll(l);
    Object o = null;
    if (l.isEmpty()) { o.toString(); }
  }
  ...
  void plainGetOk(List l, int i) { l.get(i).toString(); }
  Object getElement(List l) { return l.isEmpty() ? null : l.get(0); }
  ...
  void addAndRemoveEmptinessNPEBad() {
    ...
    l.add(i);
    l.remove(i);
    if (l.isEmpty()) { getElement(l).toString(); }
  }
  void FP_removeOnEmptyListOk() {
    List l = new LinkedList();
    Object removed = l.remove(0);
    if (removed != null) { getElement(l).toString(); }
  }
