...
class ArrayListTest {
  void alloc_is_negative_bad() { ArrayList<Integer> x = new ArrayList<Integer>(-1); }
  void alloc_is_ok() { ArrayList<Integer> x = new ArrayList<Integer>(9); }
  void add_in_loop_ok() {
    ArrayList<Integer> a = new ArrayList<>();
    for (int i = 0; i < 5; i++) { a.add(0); }
    int j = a.get(3);
  }
  ...
  void add_in_loop_by_param_ok(ArrayList<Integer> b) {
    ArrayList<Integer> a = new ArrayList<>();
    for (int i = 0; i < b.size(); i++) { a.add(0); }
  ...
  void add_in_loop_by_param2_ok(ArrayList<Integer> b) {
    ArrayList<Integer> a = new ArrayList<>();
    for (int i = 0; i < b.size(); i++) { if (unknown_bool) { a.add(0); } }
    if (a.size() > 0) { int j = b.get(a.size() - 1); }
  }
  ...
  void add_in_loop_by_param3_ok(ArrayList<Integer> b) {
    ArrayList<Integer> a = new ArrayList<>();
    if (b.size() > 0) {
      for (int i = 1; i < b.size(); i++) { a.add(0); }
  ...
  void remove_in_loop_iterator_good(ArrayList<Integer> b) {
    ArrayList<Integer> a = new ArrayList<>();
    for (Integer i : b) { a.add(i); }
    for (Integer i : b) { a.remove(i); }
    if (a.size() < 0) { int j = b.get(b.size()); }
  }
  ...
  void add_in_loop_iterator2_ok(ArrayList<Integer> b) {
    ArrayList<Integer> a = new ArrayList<>();
    for (Integer i : b) { if (unknown_bool) { a.add(i); } }
    if (a.size() > 0) { int j = b.get(a.size() - 1); }
  }
  ...
  interface MyI { public ArrayList<Integer> mk_unknown(); }
  ...
  void loop_on_unknown_iterator_FN(MyI x, int j) {
    ArrayList<Integer> a = new ArrayList<>();
    ArrayList<Integer> b;
    if (unknown_bool) { b = a; } else { b = x.mk_unknown(); }
    for (Integer i : b) {
      if (a.size() <= -1) {
        int[] c = new int[5];
        c[5] = 0;
